...
public class PetService {
    ...
    public List<Pet> save(List<CreatePetRQ> petCreateRequestList) {
        List<Pet> newPetList = new ArrayList<>();
        Pet newPet;
        for (CreatePetRQ createPetRQ : petCreateRequestList) {
...
//    }
    ...
    public static Shelter saveinshelter(List<Pet> pets, Long id) {
        List<Pet> newPetList = new ArrayList<>();
